...
if [ $SYS = "Linux" ]; then
    DEFS=NVLinux
    LIBRARIES="-L$PFM_LIB -lllz -lchrtr2 -lnvutility -lBinaryFeatureData -lbag -lxml2 -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="XML_LIBRARY WIN32 NVWIN3X"
    LIBRARIES="-L$PFM_LIB -lllz -lchrtr2 -lnvutility -lBinaryFeatureData -lbag -lxml2 -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -liconv"
